...
CONTROL_FILMS = [
    ...
    ("The Wailing (2016)",                     "Korean horror — possession, rural village, not generic horror"),
    ("Exhuma (2024)",                          "Korean horror — possession, rural village, not generic horror"),
    ("Marty Supreme (2025)",                    "Uplifting sports dramas"),
    ("Silent Hill (2006)",                      "Horror — supernatural, isolated town"),
    ...
    ("Red Rocket (2021)",                      ""),
    ("Anora (2024)",                           ""),
    ("Hardcore Henry (2015)",  "POV action — Ilya Naishuller, first-person continuous chase"),
    ...
    ("Ex Machina (2015)",                      "AI thriller — contained, philosophical, Garland"),
    ("Annihilation (2018)",                    "Sci-fi horror — alien invasion, psychological, Alex Garland"),
    ("The Insider (2000)",                     "Tobacco industry, true story, Michael Mann"),
    ("Starship Troopers (1997)",               "Sci-fi satire — fascism parody, Verhoeven"),
    # Action/Thriller
    ("Die Hard (1988)",                        "Confined action — single building, genre-defining"),
    ("Lethal Weapon (1987)",                   "Buddy cop action — Riggs/Murtaugh dynamic"),
    ...
    ("Enemy (2013)",                           "Psychological thriller — doppelganger, Villeneuve, spider"),
...
def run_probe(engine, source_title, hint, top_n=10, priority="balanced",
              exclude_obscure=False, debug=False, exclude_sequels=False):
...
def main():
    ...
    for source, hint in probes:
        run_probe(engine, source, hint,
                  ...
                  exclude_obscure=exclude_obscure,
                  debug=args.debug,
                  exclude_sequels=args.no_sequels)
